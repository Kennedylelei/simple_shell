 ...
 * @estr:  shows a string containing specified error type
 * Return: 0 if no numbers in string, converted number otherwise
 *        -1 on error
 *
 */
 ...
 * @input:  this shows the input
 * @fd: this shows the filedescriptor to write to
 *
 ...
 * @buf: shows the address of the string to modify
 *
 * Return: Always 0;
 */
