...
/**
 * is_chain - used to test if current char in buffer is a chain delimeter
 * @info: shows the parameter struct
 * @buf:  shows the char buffer
 ...
 * @info: shows the parameter struct
 * @buf: shows the char buffer
 * @p: shows the address of current position in buf
...
/**
 * replace_alias - this is used to replace an aliases in the tokenized string
 * @info: shows the parameter struct
 *
...
/**
 * replace_string - this is used to replace a string
